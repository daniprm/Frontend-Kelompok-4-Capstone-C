...
export default async function LihatSemuaPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      {/* Header Section */}
      <div className="relative bg-gradient-to-br from-gray-900 via-purple-900 to-orange-900 text-white py-28 overflow-hidden">
        {/* Floating Orbs */}
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative">
              ...
              <div className="relative w-24 h-24 bg-gradient-to-br from-orange-500 via-amber-500 to-purple-600 rounded-3xl flex items-center justify-center transform transition-transform duration-500 hover:scale-110 hover:rotate-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight animate-fade-in-up">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-300 to-purple-400 animate-gradient-shift">Destinasi</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 font-light leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                Jelajahi <span className="font-bold text-orange-300">{destinations.length} destinasi</span> wisata kuliner dan
                non-kuliner menakjubkan di <span className="font-bold text-purple-300">Kota Pahlawan</span>
              </p>
      ...
      <div className="relative py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-gray-50 via-purple-50/20 to-gray-50" />
        <div className="absolute top-20 right-20 w-[500px] h-[500px] bg-gradient-to-r from-orange-200/20 to-purple-200/20 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-gradient-to-r from-purple-200/20 to-amber-200/20 rounded-full blur-3xl" />
          ...
          {destinations.length === 0 && (
            <div className="text-center py-32 animate-fade-in-up">
              <div className="relative inline-block mb-8">
                ...
                <div className="relative w-32 h-32 bg-gradient-to-br from-orange-500 via-amber-500 to-purple-600 rounded-3xl flex items-center justify-center mx-auto transform transition-transform duration-500 hover:scale-110 hover:rotate-12">
