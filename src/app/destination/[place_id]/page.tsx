  ...
  useEffect(() => {
    ...
    async function loadDestination() {
      try {
        ...
        console.log(
          '📍 Sample place_ids:',
          allDestinations.slice(0, 5).map((d) => d.place_id)
        );
        ...
        console.log(
          '✅ Found destination:',
          foundDestination?.nama || 'Not found'
        );
        ...
        if (foundDestination) {
          ...
          setDestination({
            ...
            deskripsi:
              'Informasi detail destinasi ini sedang dalam proses pembaruan. Silakan kembali lagi nanti untuk informasi yang lebih lengkap.',
            rating: 4.0,
        ...
        setDestination({
          ...
          coordinates: [-7.2458, 112.7378],
          deskripsi:
            'Terjadi kesalahan saat memuat informasi destinasi. Silakan coba lagi nanti.',
          rating: 4.0,
          alamat: 'Alamat belum tersedia, Surabaya, Jawa Timur',
          jam_buka: '08:00 - 17:00 WIB',
          image_url: `https://picsum.photos/seed/${placeId}/1920/800`,
